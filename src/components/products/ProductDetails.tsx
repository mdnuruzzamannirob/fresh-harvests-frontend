  ...
  return (
    ...
    >
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <motion.div
          variants={item}
          className="rounded-xl space-y-3 flex flex-col justify-between overflow-hidden border border-gray-30 shadow-xs p-5 relative"
        >
        ...
        {/* Product Details */}
        <motion.div variants={item} className="flex-1 space-y-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-100">(0 reviews)</span>
          </div>
      ...
      {/* Tabs Section */}
      <motion.div variants={item} className="w-full space-y-5 overflow-hidden">
        <div className="flex items-center gap-3">
          <button
